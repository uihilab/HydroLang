...
export default {
    ...
    "stations-lastdays": {
        "endpoint": "http://api.meteonetwork.it/xml_rpc/public/jsonrpc/getDailyStationLastDays",
        "params": {
            "username": null,
            "token": null,
            "stationCode": null,
    ...
    "station-singledate": {
        "endpoint": "http://api.meteonetwork.it/xml_rpc/public/jsonrpc/getDailyStationSingleDate",
        "params": {
            "username": null,
            "token": null,
            "stationCode": null,
    ...
    "stations-singledate": {
        "endpoint": "http://api.meteonetwork.it/xml_rpc/public/jsonrpc/getDailyStationsSingleDate",
        "params": {
            "username": null,
            "token": null,
            "date": null,
    ...
    "stations-singledate-country": {
        "endpoint": "http://api.meteonetwork.it/xml_rpc/public/jsonrpc/getDailyStationsSingleDateByCountry",
        "params": {
            "username": null,
            "token": null,
            "date": null,
    ...
    "NearStations": {
        "endpoint": "http://api.meteonetwork.it/xml_rpc/public/jsonrpc/getNearStations",
        "params": {
            "username": null,
            "token": null,
            "lat": null,
