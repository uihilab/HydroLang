...
function Layers(config) {
    ...
    if (config.maptype == "google") {
        ...
        if (layertype == 'tile') {
            ...
            layer = new L.TileLayer(tileprov[tiletype].url, tileprov[tiletype].options);
    ...
    return geogoogle;
        ...
        var geopoint = () => {
            ...
            const fig = svg.selectAll('circle')
                ...
                .attr("stroke", "black")
                .attr("cx", d =>
                    osmap.latLngToLayerPoint([d.geometry.coordinates[1], d.geometry.coordinates[0]]).x)
                .attr("cy", d =>
                    osmap.latLngToLayerPoint([d.geometry.coordinates[1], d.geometry.coordinates[0]]).y)
                .attr("r", 5)
